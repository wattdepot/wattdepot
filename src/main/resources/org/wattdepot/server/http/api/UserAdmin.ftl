    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <a class="panel-title text-right accordion-toggle collapsed" data-toggle="collapse" data-parent="#help"
           href="#collapseHelp">Help </a>
      </div>
      <div id="collapseHelp" class="panel-collapse collapse">
        <div class="panel-body">
          Use the following steps to create your Organizations and Users.
          <ol>
            <li>Create an Organization without any users in it. This is important since the persistence requires users
              to be members of an organization and the organization must exist before users are created.
            </li>
            <li>Create one or more users (one at a time). When creating the user choose the organization they are
              members of.
            </li>
          </ol>
          <p>Deleting an organization deletes all the items in the organization. This is a very <em>dangerous</em>
            opperation.</p>
        </div>
      </div>
    </div>
  ...
  <div class="tab-content">
    <div class="tab-pane active" id="organizations">
      ...
      <div class="row">
        ...
        <div class="col-xs-1">
          <button data-toggle="modal" data-target="#addOrganizationModal" class="btn btn-primary btn-sm add-button">
      ...
      <table id="organizationTable" class="table tablesorter">
        ...
        <#list orgs as g>
          ...
          <tr>
            <td>${g.id}</td>
            <td>${g.name}</td>
            <td><#list g.users as u>${u} </#list></td>
            <td>
              <#if g.id != "admin"><a href="#"><span class="glyphicon glyphicon-pencil"
                                                     onclick="edit_organization_dialog(event, '${g.id}');"></span></a></#if>
            </td>
            <td>
              <#if g.id != "admin"><a href="#"><span class="glyphicon glyphicon-remove"
                                                     onclick="delete_organization_dialog(event, '${g.id}');"></span></a></#if>
            </td>
          </tr>
          </#if>
        </#list>
    ...
    <div class="tab-pane" id="users">
      ...
      <div class="row">
        ...
        <div class="col-xs-6"></div>
        <div class="col-xs-1">
          <button data-toggle="modal" data-target="#addUserModal" class="btn btn-primary btn-sm add-button"><span
      ...
      <table id="userTable" class="table tablesorter">
        ...
        <#list users as u>
          ...
          <tr>
            ...
            <td>
              <#if u.uid != rootUid><a href="#"><span class="glyphicon glyphicon-pencil"
                                                      onclick="edit_user_dialog(event, '${u.uid}');"></span></a></#if>
            </td>
            <td>
              <#if u.uid != rootUid><a href="#"><span class="glyphicon glyphicon-remove"
                                                      onclick="delete_user_dialog(event, '${u.uid}');"></span></a></#if>
            </td>
          </tr>
          </#if>
        </#list>
        ...
        <div class="container">
          <form id="add-org">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="organization_id" class="form-control" required data-parsley-slug/>
                <p class="help-block">Organization id must be unique and be a slug. Slugs consist of lowercase letter,
        ...
        <div class="container">
          <form id="edit-org">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="edit_organization_name" class="form-control" required/>
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  ...
                  <p class="help-block">To edit the users in the Organization, you must create or delete the users since
                    you cannot change their Organization.</p>
                </div>
              </div>
            </div>
            <div class="clearfix"></div>
        ...
        <div class="container">
          <form id="add-user">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="user_id" class="form-control" required data-parsley-slug/>

                <p class="help-block">Unique user id.</p>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select class="form-control" name="user_organization" required>
        ...
        <div class="container">
          <form id="edit-user">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="edit_user_id" class="form-control" disabled>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="edit_user_firstname" class="form-control" required/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="edit_user_lastname" class="form-control" required/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="email" name="edit_user_email" class="form-control" required/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="password" name="edit_user_password" class="form-control" required/>
...
<script>
  ...
  USERS["${u.uid}"] = {
    "id": "${u.uid}",
    "firstName": "${u.firstName!"none"}",
    "lastName": "${u.lastName!"none"}",
    "email": "${u.email!"none"}",
    "organizationId": "${u.organizationId!"none"}",
    "properties": [<#assign k = u.properties?size><#list u.properties as p>{
      "key": "${p.key}",
      "value": "${p.value}"
