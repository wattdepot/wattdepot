...
function splitQuery(server, source, dataType, startTime, endTime, interval) {
    ...
    */
    ...
    query = new google.visualization.Query(server +'wattdepot/admin/depository/power/measurements/gviz/?sensor='+ source +'&start='+wdClient.getTimestampFromDate(startTime)+'&end='+wdClient.getTimestampFromDate(endTime)+'&samplingInterval='+interval);
    query.setQuery('select timePoint, ' + dataType);
    query.setTimeout(queryTimeOut);
    returnArray.push(query);
    return returnArray;
