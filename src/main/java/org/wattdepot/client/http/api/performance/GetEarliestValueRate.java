/**
 * GetEarliestValueRate.java This file is part of WattDepot.
 *
...
/**
 * GetEarliestRate - Starts up a process that get the earliest value from the
 * WattDepot server at the given rate of measurements per second.
 * 
 * @author Cam Moore
 * 
 */
public class GetEarliestValueRate {
  ...
  public static void main(String[] args) throws BadCredentialException, IdNotFoundException,
    ...
    for (int i = 0; i < getsPerSec; i++) {
      t.schedule(new GetEarliestValueTask(serverUri, username, organizationId, password, debug), 0,
          1000);
    }
  }
