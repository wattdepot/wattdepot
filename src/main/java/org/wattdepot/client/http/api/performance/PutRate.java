/**
 * PutRate.java This file is part of WattDepot.
 *
...
/**
 * PutRate - Starts up a process that sends Measurements to the
...
public class PutRate {
  ...
  public static void main(String[] args) throws BadCredentialException, IdNotFoundException,
    ...
    for (int i = 0; i < measPerSec; i++) {
      t.schedule(new PutTask(serverUri, username, organizationId, password, debug), 0,
          1000);
    }
  }
