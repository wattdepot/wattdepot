/**
 * GetIntervalValueRate.java This file is part of WattDepot.
 *
 ...
 * 
 */
public class GetIntervalValueRate {
  ...
  public static void main(String[] args) throws BadCredentialException, IdNotFoundException,
    ...
    for (int i = 0; i < getsPerSec; i++) {
      t.schedule(new GetIntervalValueTask(serverUri, username, organizationId, password, debug), 0,
          1000);
    }
  }
