/**
 * GetDateValueRate.java This file is part of WattDepot.
 *
...
/**
 * GetDateValueRate - Starts up a process that get the value between two dates from the
 * WattDepot server at the given rate of measurements per second.
 * 
 * @author Cam Moore
 * 
 */
public class GetDateValueRate {
  ...
  public static void main(String[] args) throws BadCredentialException, IdNotFoundException,
    ...
    for (int i = 0; i < getsPerSec; i++) {
      t.schedule(new GetDateValueTask(serverUri, username, organizationId, password, debug), 0,
          1000);
    }
  }
